...
// 1. Create File Entity from 'sites/default/files/hero-monitor-v2.png'
$uri = 'public://hero-monitor-v2.png';
$file = File::create([
  'uri' => $uri,
  'uid' => 1,
  'status' => 1,
...
$file->save();
echo "Created File Entity (V2): " . $file->id() . "\n";
...
if ($node && !$node->get('field_components')->isEmpty()) {
  ...
  if ($paragraph) {
    ...
    $paragraph->save();
    echo "Paragraph Updated with Image V2.\n";
  } else {
