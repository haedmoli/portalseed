...
// New Body with Drupal ICON as IMAGE
$social_body = <<<HTML
<div class="footer-social">
  <div class="social-icons">
    ...
    <a href="https://www.drupal.org/seed-em" class="social-icon drupal" aria-label="Drupal - Seed EM" target="_blank" rel="noopener">
      <img src="/themes/custom/seed_theme/images/drupal-icon.png" alt="Drupal" style="width: 20px; height: 20px; object-fit: contain;">
    </a>
...
if ($block) {
    ...
    $block->save();
    echo "Updated Social Block Content with Image File\n";
} else {
