...
// 1. Create File Entity from 'media__1771514351758.png' (163KB) aka V4 image
// First copy it to public files
$source = '/home/haed/.gemini/antigravity/brain/25076aaa-62b4-48dd-8fcd-a3d1ddebfd97/media__1771514351758.png';
$destination = 'public://hero-final-real-v4.png';

$file_system = \Drupal::service('file_system');
$file_system->copy($source, $destination, \Drupal\Core\File\FileSystemInterface::EXISTS_REPLACE);
...
$file->save();
echo "Created File Entity (V4): " . $file->id() . "\n";
...
if ($node && !$node->get('field_components')->isEmpty()) {
  ...
  if ($paragraph) {
    ...
    $paragraph->save();
    echo "Paragraph Updated with Image V4.\n";
  } else {
