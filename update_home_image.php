...
// 1. Create File Entity from 'sites/default/files/hero-code.png'
$uri = 'public://hero-code.png';
$file = File::create([
  'uri' => $uri,
  'uid' => 1,
  'status' => 1,
...
$file->save();
echo "Created File Entity: " . $file->id() . "\n";
...
if ($node && !$node->get('field_components')->isEmpty()) {
  ...
  if ($paragraph) {
    ...
    $paragraph->save();
    echo "Paragraph Updated with Image.\n";
  } else {
    echo "Paragraph not found (revision issue?). Loading latest revision.\n";
